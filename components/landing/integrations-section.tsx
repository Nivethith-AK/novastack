          ...
          <div className="relative z-10 p-8 lg:p-12">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="font-mono text-xs text-muted-foreground space-y-2 bg-background/50 rounded-lg p-6 border border-border">
                ...
                <div>
                  <span className="text-emerald-400">const</span> response = <span className="text-lime-400">await</span> novastack.send({'{'}
                </div>
                <div className="pl-4">
                  <span className="text-green-400">channel</span>: <span className="text-lime-300">&quot;#general&quot;</span>,
                </div>
                <div className="pl-4">
                  <span className="text-green-400">message</span>: <span className="text-lime-300">&quot;AI inference complete&quot;</span>
                </div>
                <div>{'}'});</div>
              </div>
            </div>
